  ...
  },
  {
    ...
    content: (
      <div>
        ...
        <ul className="list-disc leading-5 pl-0 sm:leading-7 sm:pl-5 space-y-1">
          <ListItem point="Revamped the Sign up and Login process of our React app using AWS Cognito, introducing a mandatory TOTP-based Multi-Factor Authentication(MFA) process for enhanced security." />
          <ListItem point="Implemented Code Splitting and Lazy Loading with React Suspense, significantly reducing initial load time." />
          <ListItem point="Created a private NPM library using GitHub packages for our shared components enabling consistent usage across multiple repositories. Added Storybook, Chromatic and Vitest for TDD." />
          <ListItem point="Developed a secure, internal company use, conversational AI Chatbot, inspired by ChatGPT, utilizing GPT-4 APIs, with Google authentication for access control deploying it on AWS Amplify." />
          ...
          <ListItem point="Utilized Lighthouse & Profiler to optimize performance bottlenecks, improving the overall efficiency." />
          <ListItem point="Migrated our landing page from React JS to Next JS, improving performance, Web Vitals and SEO optimization." />
        </ul>
      </div>
    ),
  },
  {
    ...
    content: (
      <div>
        ...
        <ul className="list-disc leading-5 pl-0 sm:leading-7 sm:pl-5 space-y-1">
          <ListItem point="Utilized Styled Components, TypeScript and React hooks to develop reusable functional components, translating Figma designs into web pages." />
  ...
  },
  {
    ...
    content: (
      <div>
        ...
        <ul className="list-disc leading-5 pl-0 sm:leading-7 sm:pl-5 space-y-1">
          <ListItem point="Architected an automation script using Python & Sikuli to perform front end automation of daily DBA activities related to user management." />
          <ListItem point="Attained team’s target to reduce manual work of ticket solving by 120-man hours per month by automating the processes following agile methodology." />
